...
export class ClearWorkflow extends LifecycleWorkflow<ClearParams> {
  protected async execute(event: WorkflowEvent<ClearParams>, step: WorkflowStep): Promise<void> {
